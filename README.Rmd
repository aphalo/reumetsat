...
Installation of the current unstable version from the R-Universe CRAN-like repository can be done with the code below. Including the URLs of the CRAN and Bioconductor repositories ensures that dependencies are installed automatically.
